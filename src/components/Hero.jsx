...
const Hero = () => {
    ...
    return (
        <section id="home" className="relative pt-32 lg:pt-24 flex items-center min-h-screen overflow-hidden perspective-container">
            {/* 3D Cube Container */}
            <div
                className="w-full h-full absolute inset-0 transition-transform duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)] preserve-3d scale-[0.85] md:scale-100"
                style={{
            ...
            >
                ...
                <div className="absolute inset-0 w-[100vw] h-full flex flex-col items-center justify-center text-center backface-hidden pt-20 pb-12"
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold hero-gradient-text mb-4 leading-tight">
                ...
                <div className="absolute inset-0 w-[100vw] h-full flex flex-col items-center justify-center text-center backface-hidden pt-20 pb-12"
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-purple-300 mb-4 leading-tight">Meet Avira — Your AI Assistant</h1>
                ...
                <div className="absolute inset-0 w-[100vw] h-full flex flex-col items-center justify-center text-center backface-hidden pt-20 pb-12"
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-sky-300 mb-4 leading-tight">Hi, I’m Abikrishna</h1>
                ...
                <div className="absolute inset-0 w-[100vw] h-full flex flex-col items-center justify-center text-center backface-hidden pt-20 pb-12"
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-emerald-300 mb-6 leading-tight">Our Mission & Vision</h1>
            ...
            {/* Controls */}
            <div className="carousel-controls absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex items-center gap-4 bg-black/20 backdrop-blur-sm p-2 rounded-full border border-white/10">
